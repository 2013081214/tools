...
public class addAlternativeFeature extends JInternalFrame {
	 ...
	 * Create the frame.
	 */
	public addAlternativeFeature() {
		setClosable(true);
		setResizable(true);
		setTitle("Decompose Feature to Alternative Feature");
		...
		featurenameList = featuredatamodel.Dom4jGetAlternativeFeatureList();
		Vector v = new Vector();
